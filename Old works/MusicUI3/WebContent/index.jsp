...
<figure id="slide">
        <img id="1" src="indeximages/aboutpageimg.jpg"style='position:absolute;top:0px;left:0px;width:100%;height:100%;z-index:-1;'>
        <img id="2" src="indeximages/classpageimg.jpg" style='position:absolute;top:0px;left:0px;width:100%;height:100%;z-index:-1;'>
        <img id="3" src="indeximages/menu.jpg"style='position:absolute;top:0px;left:0px;width:100%;height:100%;z-index:-1;line-height:0.0;' >
</figure>
...
<img src="indeximages/now-open.png" style='position:absolute;width:150px; height:130px; margin-left:50px;top:830px;'>
    ...
    <div><div class="trans">
   <img src="indeximages/centreImg.jpg" width="590px" height="320px" />
    </div>
    <div class="sideblue">
    </div>
    </div>
     ...
     <!-- Large Mike Image -->
    <div>
    <img src="indeximages/centreImg.jpg" style="margin-top:610px;position:relative;float:left;width:612px;height:685px;margin-left:-20px;">
    ...
    <img src="indeximages/arrow.png" style='float:right;margin-right:250px;margin-top:-80px;width:30px;height:20px;'>
    </div> 
    </div>
  ...
  <div class="textarea">
    ...
    <h2 style="line-height:5.0px">Me&Music Barre<h4>5:30pm-6:30pm</h4></h2>
  	...
  	<img src="indeximages/arrow.png" style='float:right;margin-right:320px;margin-top:-42px;width:30px;height:20px;'>
 </div>



<img src="indeximages/upcoming-home.jpg" style='float: right; margin:-10px 0 500px 500px;float:right; padding-top:150px; '>
<img src="indeximages/classroom.jpg" style='margin-top:-495px;width:1250px; height:560px;'>

<div class="joinme">
<h1 style="padding-top:150px;font-family:times new roman;font-family:baskerville old face;font-size:300%;">Join Me&Music.<h1>
<h3 style="line-height:0.0px; font-family:comic sans ms;">Join our email list to get <b>your first 10 days free.</b></h3>
